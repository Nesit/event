...
Rails.application.config.sorcery.submodules = [:remember_me, :user_activation, :external, :reset_password]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.key = "392802290814243"
  config.facebook.secret = "41999de063d43cd5f1ec46f89413f645"
  config.facebook.callback_url = "http://event.ru/users/callback?provider=facebook"
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = UserActivationMailer
